...
const sortPeople = (arr) => {
  arr.sort((a,b) => {
    if (a.lastName.toUpperCase() > b.lastName.toUpperCase()) {
      return 1;
    } else if (b.lastName.toUpperCase() > a.lastName.toUpperCase()) {
      return -1;
    } else {
      return 0;
    }
...
const sortPeopleBetter = (arr) => {
  arr.sort((a,b) => {
    if (a.lastName.toUpperCase() > b.lastName.toUpperCase()) {
      ...
      return 1;
    } else if (b.firstName.toUpperCase() > a.firstName.toUpperCase()) {
      return -1;
    } else {
      return a.age - b.age;
    }
...
const sortSchedule = (arr) => {
  ...
  arr.sort((a,b) => {
    let dayNumA = null;
    let dayNumB = null;
    let startTimeA = parseInt(a.start);
    let startTimeB = parseInt(b.start);
    let endTimeA = parseInt(a.end);
    let endTimeB = parseInt(b.end);
